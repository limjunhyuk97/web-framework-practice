...
function getLanguage(_x) {
  return _getLanguage.apply(this, arguments);
}

function _getLanguage() {
  _getLanguage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(target) {
    var data;
...
var isNodeChanged = function isNodeChanged(node1, node2) {
  ...
  var n2Attributes = node2.attributes; //*  어트리뷰트 노드 비교 */
...
var applyDiff = function applyDiff(parentNode, realNode, virtualNode) {
  ...
  var virtualChildren = Array.from(virtualNode.children); // 자식들에 대해서 applyDiff를 재귀적으로 수행
...
var renderWrapper = function renderWrapper(component) {
  return function (targetElement, state) {
    var VDOM = component(targetElement, state);
...
var renderRoot = function renderRoot(root, state) {
...
var getSearchedList = function getSearchedList(result) {
  var text = result.text,
      suggested = result.suggested;
  return "\n    <li class=\"".concat(suggested ? "Suggestion__items--selected" : "", "\">").concat(text, "</li>\n  ");
};

var _default = function _default(targetElement, _ref) {
  var searchResult = _ref.searchResult;
  targetElement.style.border = searchResult.length === 0 ? "none" : "1px solid black";
  var newSearchedList = targetElement.cloneNode(true);
  var searchedElements = searchResult.map(getSearchedList).join("");
...
_registry.default.add("SearchedResult", _searched.default); // 상태 -> 오직 상태에만 순수하게 의존하여 렌더링 되는 화면 구현
...
var render = function render() {
  window.requestAnimationFrame(function () {
    ...
    var newMain = _registry.default.renderRoot(main, state);
...
var target = ["java", "py", "c"];

var curTarget = function () {
  var num = 0;
...
window.setInterval( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _api.default)(state.target);

        case 3:
          state.searchResult = _context.sent.map(function (el, idx) {
            return {
              text: el,
              suggested: idx === 0 ? true : false
            };
          });
          console.log(state);
          render();
...
render();
},{"./API/api":"API/api.js","./applyDiff":"applyDiff.js","./registry":"registry.js","./view/searched":"view/searched.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/JFrame1.e31bb0bc.js.map